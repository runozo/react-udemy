...
/***/ (function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = 'http://api.openweathermap.org/data/2.5/weather?units=metric&APPID=ca2ad824250da04814f343e3dfcd8ea6';
	...
	module.exports = {
	    getTemp: function getTemp(location) {
	        ...
	        return _axios2.default.get(requestUrl).then(
	        // success
	        function (res) {
